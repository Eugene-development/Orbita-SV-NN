            ...
            <div class="mt-6 sm:mt-8">
                <nav>
                    <div class="grid gap-7 sm:grid-cols-2 sm:gap-y-8 sm:gap-x-4">
                        ...
                        <a class="-m-3 flex items-center p-3 rounded-lg hover:bg-gray-50" href="/company">
                            <div
                              class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-indigo-500 text-white sm:h-12 sm:w-12">
                        ...
                        <a class="-m-3 flex items-center p-3 rounded-lg hover:bg-gray-50" href="/information/contact">
                            <div
                              class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-indigo-500 text-white sm:h-12 sm:w-12">
                    ...
                    <div class="mt-8 text-base">
                        <a class="font-medium text-indigo-600 hover:text-indigo-500" href="#"> Информационные материалы
        ...
        <div class="py-6 px-5">
            <div class="grid grid-cols-2 gap-4">
                {#each leftInfo as { href, displayName }}
                    <a href="{href}" class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700"> {displayName} </a>
                {/each}
            ...
            <div class="mt-6">
                <a href="/blog" class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> Наш Блог </a>
            </div>
        </div>
    </div>
</div>
