        ...
        <div class="max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
            <div class="pr-16 sm:text-center sm:px-16">
                <p class="font-medium text-white">
                    <span class="md:hidden text-lg">8 (800) 555-8-111</span>
                    <span class="hidden md:inline text-lg">8 (800) 555-8-111</span>
                    <span class="block sm:ml-4 sm:inline-block">info@orbita-stroy.com</span>
                    <span class="block sm:ml-4 sm:inline-block">Пн-Пт 8:00-17:30; Сб 9:00-16:00</span>
                </p>
            </div>
        </div>
    </div>
